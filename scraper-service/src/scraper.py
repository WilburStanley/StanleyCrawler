...
def discover_book_urls(config):
    ...
    return unique_book_urls, book_source_pages, catalogue_pages_visited


def run_scrape(config):
    run_started_at = datetime.now(timezone.utc)

    unique_book_urls, book_source_pages, catalogue_pages_visited = discover_book_urls(config)
    ...
    for index, book_url in enumerate(unique_book_urls):
        ...
        try:
            ...
            raw_record = extract_book_record(book_url, source_page, detail_cache_path, config)
